      ...
      <div class="max-w-3xl mx-auto">
        ...
        <div class="stagger space-y-10 md:space-y-12">
          <div class="sr flex gap-5 md:gap-7">
            <span class="font-mono text-accent text-base font-bold mt-0.5 shrink-0 tabular-nums">01</span>
            <div>
              <h3 class="font-mono text-sm tracking-wider mb-1.5">DEVELOPER SUFFERING</h3>
              <p class="text-dim leading-relaxed">Build tools, bundlers, hydration, RSC, islands... a tower of complexity to solve problems we created. You shouldn't need a PhD in webpack to ship a form.</p>
            </div>
          </div>

          <div class="sr flex gap-5 md:gap-7">
            <span class="font-mono text-accent text-base font-bold mt-0.5 shrink-0 tabular-nums">02</span>
            <div>
              <h3 class="font-mono text-sm tracking-wider mb-1.5">CORPORATE CAPTURE</h3>
              <p class="text-dim leading-relaxed">React is Meta's. Next.js is Vercel's. Your "open" stack locks you into their cloud, their tooling, their pricing page. The web was meant to be <em>yours</em>.</p>
            </div>
          </div>

          <div class="sr flex gap-5 md:gap-7">
            <span class="font-mono text-accent text-base font-bold mt-0.5 shrink-0 tabular-nums">03</span>
            <div>
          ...
          <div class="sr flex gap-5 md:gap-7">
            <span class="font-mono text-accent text-base font-bold mt-0.5 shrink-0 tabular-nums">04</span>
            <div>
          ...
          <div class="sr flex gap-5 md:gap-7">
            <span class="font-mono text-accent text-base font-bold mt-0.5 shrink-0 tabular-nums">05</span>
            <div>
          ...
          <div class="sr flex gap-5 md:gap-7">
            <span class="font-mono text-accent text-base font-bold mt-0.5 shrink-0 tabular-nums">06</span>
            <div>
